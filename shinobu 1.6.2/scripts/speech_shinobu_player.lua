...
return {
	...
	ANNOUNCE_BEES = "I hate BEEEEES!!!!",
	ANNOUNCE_BOOMERANG = "Ow! I should try to catch that!",
	ANNOUNCE_CHARLIE = "Welcome back, Charlie.",
	ANNOUNCE_CHARLIE_ATTACK = "Interesting.",
	...
	ANNOUNCE_EAT =
	{
		...
		SPOILED = "Horrible!",
		STALE = "Emmmm.",
		INVALID = "I don't want to eat that!",
	},
	ANNOUNCE_ENTER_DARK = "It's so dark!",
	ANNOUNCE_ENTER_LIGHT = "!",
	ANNOUNCE_FREEDOM = "End of journey!",
	ANNOUNCE_HIGHRESEARCH = "Easy!",
	ANNOUNCE_HOUNDS = "The taste of blood.",
	ANNOUNCE_HUNGRY = "I am hungry >_<!!",
	...
	ANNOUNCE_INV_FULL = "Too heavy!",
	ANNOUNCE_KNOCKEDOUT = "Ugh, my head!",
	ANNOUNCE_LOWRESEARCH = "Hmmmm.",
	ANNOUNCE_MOSQUITOS = "Blood!",
	...
	ANNOUNCE_NONIGHTSIESTA_CAVE = "Good place to rest.",
	ANNOUNCE_NOHUNGERSIESTA = "I'm too hungry for a siesta!",
	ANNOUNCE_NO_TRAP = "Well, that was easy.",
	ANNOUNCE_PECKED = "Ow! Quit it!",
	ANNOUNCE_QUAKE = "Wow!",
	ANNOUNCE_RESEARCH = "Let me recall what I learnt before...",
	ANNOUNCE_SHELTER = "Comfortable",
	ANNOUNCE_THORNS = "Ow!",
	ANNOUNCE_BURNT = "Fire! Fire!",
	ANNOUNCE_TORCH_OUT = "Oops.",
	ANNOUNCE_TRAP_WENT_OFF = "Oops.",
	ANNOUNCE_UNIMPLEMENTED = "OW! I don't think it's ready yet.",
	ANNOUNCE_WORMHOLE = "Disgusting.",
	ANNOUNCE_CANFIX = "\nEasy to be fixed.",
	ANNOUNCE_ACCOMPLISHMENT = "Ah now I remember!",
	ANNOUNCE_ACCOMPLISHMENT_DONE = "Kaka!",	
	ANNOUNCE_INSUFFICIENTFERTILIZER = "Need more poops? Eh?",
	ANNOUNCE_TOOL_SLIP = "Wow that tool is slippery!",
	ANNOUNCE_LIGHTNING_DAMAGE_AVOIDED = "Nice dodge!",

	ANNOUNCE_DAMP = "Oh, H2O.",
	ANNOUNCE_WET = "My clothes appear to be permeable.",
	ANNOUNCE_WETTER = "Water way to go!",
	ANNOUNCE_SOAKED = "I hate to be soaked",
	...
	BATTLECRY =
	{
		...
		PREY = "Kaka!",
		SPIDER = "Go away!",
		SPIDER_WARRIOR = "So weak!",
	},
	COMBAT_QUIT =
	{
		GENERIC = "77777", --lol
		PIG = "I'll let him go. This time.",
		PREY = "It's so boring to keep chasing!",
	...
	DESCRIBE =
	{
		...
		BAT="That's my servants.",
		BATBAT = "Useless.",
		BATWING="This is the consequence to betray me.",
		BATWING_COOKED="At least it tastes good.",
		BEDROLL_FURRY="It's so warm and comfy.",
		BUNNYMAN="Cute.",
		FLOWER_CAVE="Interesting.",
		FLOWER_CAVE_DOUBLE="Interesting.",
		FLOWER_CAVE_TRIPLE="Interesting.",
		...
		RESEARCHLAB2 = 
		{
			GENERIC = "It looks better than the last one!",
		...
		RESURRECTIONSTONE = "An odd looking stone.",
		ROBIN =
		{
